/**
 * Escena 5B - Image Cycler Component
 * A-Frame component for automatic image cycling in Scene 5B
 */

export function registerEscena5bImageCycler() {
  AFRAME.registerComponent("escena5b-image-cycler", {
    init() {
      this.isVisible = false;
      this.currentImageIndex = 0;
      this.images = ["#escena5B-1-image", "#escena5B-2-image"];
