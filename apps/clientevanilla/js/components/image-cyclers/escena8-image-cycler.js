/**
 * Escena 8 - Image Cycler Component
 * A-Frame component for automatic image cycling in Scene 8
 */

export function registerEscena8ImageCycler() {
  AFRAME.registerComponent("escena8-image-cycler", {
    init() {
      this.isVisible = false;
      this.currentImageIndex = 0;
      this.images = ["#escena8-1-image", "#escena8-2-image"];
