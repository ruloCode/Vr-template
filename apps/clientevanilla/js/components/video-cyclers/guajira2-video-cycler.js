/**
 * Guajira 2 - Video Cycler Component
 * A-Frame component for automatic video cycling in Guajira Scene 2
 */

export function registerGuajira2VideoCycler() {
  AFRAME.registerComponent("guajira2-video-cycler", {
    init() {
      this.isVisible = false;
      this.currentVideoIndex = 0;
      this.videos = ["#guajira2-3-video"];
      ...
      window.guajira2VideoCycler = this;
    },
