/**
 * Barranca 3B - Video Cycler Component
 * A-Frame component for automatic video cycling in Barranca Scene 3B
 */

export function registerBarranca3BVideoCycler() {
  AFRAME.registerComponent("barranca3B-video-cycler", {
    init() {
      ...
      window.barranca3BVideoCycler = this;
    },
