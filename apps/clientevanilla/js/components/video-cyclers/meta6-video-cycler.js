/**
 * Meta 6 - Video Cycler Component
 * A-Frame component for automatic video cycling in Meta Scene 6
 */

export function registerMeta6VideoCycler() {
  AFRAME.registerComponent("meta6-video-cycler", {
    init() {
