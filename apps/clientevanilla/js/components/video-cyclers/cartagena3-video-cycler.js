/**
 * Cartagena 3 - Video Cycler Component
 * A-Frame component for automatic video cycling in Cartagena Scene 3
 */

export function registerCartagena3VideoCycler() {
  AFRAME.registerComponent("cartagena3-video-cycler", {
    init() {
      this.isVisible = false;
      this.currentVideoIndex = 0;
      this.videos = ["#cartagena3-1-video"];
      ...
      window.cartagena3VideoCycler = this;
    },
