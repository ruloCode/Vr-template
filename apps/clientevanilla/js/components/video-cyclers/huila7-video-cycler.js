/**
 * Huila 7 - Video Cycler Component
 * A-Frame component for automatic video cycling in Huila Scene 7
 */

export function registerHuila7VideoCycler() {
  AFRAME.registerComponent("huila7-video-cycler", {
    init() {
