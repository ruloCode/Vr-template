/**
 * Cartagena 6 - Video Cycler Component
 * A-Frame component for automatic video cycling in Cartagena Scene 6 (second screen)
 */

export function registerCartagena6VideoCycler() {
  AFRAME.registerComponent("cartagena6-video-cycler", {
    init() {
      this.isVisible = false;
      this.currentVideoIndex = 0;
      this.videos = ["#cartagena6-3-video"];
      ...
      window.cartagena6VideoCycler = this;
    },
