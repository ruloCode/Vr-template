/**
 * Meta 2 - Video Cycler Component
 * A-Frame component for automatic video cycling in Meta Scene 2
 */

export function registerMeta2VideoCycler() {
  AFRAME.registerComponent("meta2-video-cycler", {
    init() {
