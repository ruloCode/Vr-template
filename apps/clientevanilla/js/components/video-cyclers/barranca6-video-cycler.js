/**
 * Barranca 6 - Video Cycler Component
 * A-Frame component for automatic video cycling in Barranca Scene 6
 */

export function registerBarranca6VideoCycler() {
  AFRAME.registerComponent("barranca6-video-cycler", {
    init() {
      ...
      window.barranca6VideoCycler = this;
    },
