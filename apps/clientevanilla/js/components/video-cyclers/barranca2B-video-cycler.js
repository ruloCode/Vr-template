/**
 * Barranca 2B - Video Cycler Component
 * A-Frame component for automatic video cycling in Barranca Scene 2B
 */

export function registerBarranca2BVideoCycler() {
  AFRAME.registerComponent("barranca2B-video-cycler", {
    init() {
      ...
      window.barranca2BVideoCycler = this;
    },
