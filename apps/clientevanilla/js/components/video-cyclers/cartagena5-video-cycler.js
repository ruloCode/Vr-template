/**
 * Cartagena 5 - Video Cycler Component
 * A-Frame component for automatic video cycling in Cartagena Scene 5
 */

export function registerCartagena5VideoCycler() {
  AFRAME.registerComponent("cartagena5-video-cycler", {
    init() {
      this.isVisible = false;
      this.currentVideoIndex = 0;
      this.videos = ["#cartagena5-1-video"];
      ...
      window.cartagena5VideoCycler = this;
    },
