/**
 * Cartagena 4 - Video Cycler Component
 * A-Frame component for automatic video cycling in Cartagena Scene 4
 */

export function registerCartagena4VideoCycler() {
  AFRAME.registerComponent("cartagena4-video-cycler", {
    init() {
      this.isVisible = false;
      this.currentVideoIndex = 0;
      this.videos = ["#cartagena4-1-video"];
      ...
      window.cartagena4VideoCycler = this;
    },
