/**
 * Barranca 4 - Video Cycler Component
 * A-Frame component for automatic video cycling in Barranca Scene 4
 */

export function registerBarranca4VideoCycler() {
  AFRAME.registerComponent("barranca4-video-cycler", {
    init() {
      ...
      window.barranca4VideoCycler = this;
    },
