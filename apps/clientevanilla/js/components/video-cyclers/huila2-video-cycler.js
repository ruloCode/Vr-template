/**
 * Huila 2 - Video Cycler Component
 * A-Frame component for automatic video cycling in Huila Scene 2
 */

export function registerHuila2VideoCycler() {
  AFRAME.registerComponent("huila2-video-cycler", {
    init() {
