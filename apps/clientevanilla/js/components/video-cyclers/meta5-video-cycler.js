/**
 * Meta 5 - Video Cycler Component
 * A-Frame component for automatic video cycling in Meta Scene 5
 */

export function registerMeta5VideoCycler() {
  AFRAME.registerComponent("meta5-video-cycler", {
    init() {
