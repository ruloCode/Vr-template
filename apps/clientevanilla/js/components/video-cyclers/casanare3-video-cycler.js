/**
 * Casanare 3 - Video Cycler Component
 * A-Frame component for automatic video cycling in Casanare Scene 3
 */

export function registerCasanare3VideoCycler() {
  AFRAME.registerComponent("casanare3-video-cycler", {
    init() {
      ...
      window.casanare3VideoCycler = this;
    },
