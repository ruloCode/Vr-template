/**
 * Barranca 5 - Video Cycler Component
 * A-Frame component for automatic video cycling in Barranca Scene 5
 */

export function registerBarranca5VideoCycler() {
  AFRAME.registerComponent("barranca5-video-cycler", {
    init() {
      ...
      window.barranca5VideoCycler = this;
    },
