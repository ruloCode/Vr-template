/**
 * Barranca 5B - Video Cycler Component
 * A-Frame component for automatic video cycling in Barranca Scene 5B
 */

export function registerBarranca5BVideoCycler() {
  AFRAME.registerComponent("barranca5B-video-cycler", {
    init() {
      ...
      window.barranca5BVideoCycler = this;
    },
