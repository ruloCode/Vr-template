/**
 * Casanare 6 - Video Cycler Component
 * A-Frame component for automatic video cycling in Casanare Scene 6
 */

export function registerCasanare6VideoCycler() {
  AFRAME.registerComponent("casanare6-video-cycler", {
    init() {
      ...
      window.casanare6VideoCycler = this;
    },
