/**
 * Cartagena 7 - Video Cycler Component
 * A-Frame component for automatic video cycling in Cartagena Scene 7
 */

export function registerCartagena7VideoCycler() {
  AFRAME.registerComponent("cartagena7-video-cycler", {
    init() {
      ...
      window.cartagena7VideoCycler = this;
    },
