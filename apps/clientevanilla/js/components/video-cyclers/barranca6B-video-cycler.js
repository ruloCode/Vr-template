/**
 * Barranca 6B - Video Cycler Component
 * A-Frame component for automatic video cycling in Barranca Scene 6B
 */

export function registerBarranca6BVideoCycler() {
  AFRAME.registerComponent("barranca6B-video-cycler", {
    init() {
      ...
      window.barranca6BVideoCycler = this;
    },
