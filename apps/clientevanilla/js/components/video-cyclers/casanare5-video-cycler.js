/**
 * Casanare 5 - Video Cycler Component
 * A-Frame component for automatic video cycling in Casanare Scene 5
 */

export function registerCasanare5VideoCycler() {
  AFRAME.registerComponent("casanare5-video-cycler", {
    init() {
      ...
      window.casanare5VideoCycler = this;
    },
